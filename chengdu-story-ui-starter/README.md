...
- Màn hình loading kiểm tra thư viện, tải phần cập nhật và chuẩn bị bộ dịch Trung ↔ Việt trước khi vào game.
- Chrome có thể yêu cầu bấm xác nhận một lần trước khi tải gói dịch tích hợp xuống thiết bị.
